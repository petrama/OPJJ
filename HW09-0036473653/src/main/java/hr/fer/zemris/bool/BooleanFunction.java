...
public interface BooleanFunction extends NamedBooleanSource {
	...
	/**
	 * Metoda koja vraća listu svih minterma funkcije.
	 * @return lista minterma.
	 */
	List<Integer> getMinterms();
	/**
	 * Metoda koja vraća listu svih maksterma funkcije.
	 * @return lista maksterma.
	 */
	List<Integer> getMaxterms();
	
	/**
	 * Metoda koja vraća listu svih dont-careova funkcije.
	 * @return lista dont-careova.
	 */
	List<Integer> getDonts();
