...
public class ValueWrapper {
	 ...
	 */
	public static Object parseToNumber(ValueWrapper se) {
		Object second=se.value;
	 ...
	 */
	public Object aritmetic(ValueWrapper second, char operation) {
		if (this.value == null) {
			this.value = Integer.valueOf(0);
		}
		if (second.value == null) {
			second.value = Integer.valueOf(0);
		}

		if (this.value instanceof String) {
			this.value = parseToNumber(this);
		}
		if (second.value instanceof String) {
			second.value = (parseToNumber(second));
		}

		if (value instanceof Integer && second.value instanceof Double) {
			this.value = new Double((Integer) value);

		} else {
			if (value instanceof Double && second.value instanceof Integer) {
				second.value = new Double((Integer) second.value);
			}
		}

		if (this.value instanceof Integer) {
			return calculate((Integer) value, (Integer) second.value, operation);
		}

		if (this.value instanceof Double) {
			return calculate((Double) value, (Double) second.value, operation);
		}
	 ...
	 */
	public void increment(ValueWrapper incValue) {
	 ...
	 */
	public void decrement(ValueWrapper decValue) {
	 ...
	 */
	public void multiply(ValueWrapper mulValue) {
	 ...
	 */
	public void divide(ValueWrapper divValue) {
	 ...
	 */
	public int numCompare(ValueWrapper withValue) {
